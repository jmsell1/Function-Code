...
def singleside(img, rad, newfile = ''):
    ...
    mask1 = np.linspace(0, width, int(width+1)) #This section of code I found uses mask1 as an image, rather than using linspace (could use resized black-white gradient image?)                    #.resize(src1.shape[1::-1]), Image.BILINEAR)
